...
public:
    ...
    inline constexpr Vector3(): m_x(0), m_y(0), m_z(0) {
    }

    inline constexpr Vector3(T x, T y, T z): m_x(x), m_y(y), m_z(z) {
    }
    ...
    inline bool equals(const Vector3& rhs, double epsilon) const {
